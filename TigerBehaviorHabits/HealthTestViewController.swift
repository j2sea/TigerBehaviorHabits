...
class HealthTestViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if isFromGame == "HardMode"{
            loadQuestionFile(filename: "HHard")
        }else if isFromGame == "MediumMode"{
            loadQuestionFile(filename: "HMedium")
        }else{
            loadQuestionFile(filename: "HEasy")
        }
...
@IBAction func Next(_ sender: Any) {
    ...
    {
        print("EXAM COMPLETE")
        let VC = self.storyboard?.instantiateViewController(withIdentifier: "HealthResultViewController") as! HealthResultViewController
        VC.arrExam = arrExam
